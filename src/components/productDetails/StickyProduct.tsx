...
export default function StickyProduct() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (!myElement.current) return; // Early return if element not found

      if (scrollPosition >= 500) {
        myElement.current.classList.add("show");
      } else {
        myElement.current.classList.remove("show");
      }
    };
  ...
  return (
    <div ref={myElement} className="tf-sticky-btn-atc">
