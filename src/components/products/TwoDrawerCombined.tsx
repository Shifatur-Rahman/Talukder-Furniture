...
import { twoDrawerCombinedCabinetMain } from "@/data/TwoDrawerCombined"; 
...
export default function twoDrawerCombinedCabinet({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: twoDrawerCombinedCabinetMain });
  }, [ 
    price,
    availability,
    color,
