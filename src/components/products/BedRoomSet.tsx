...
import { bedRoomSetMain } from "@/data/bedRoomSet"; 
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1
interface BedRoomSetProps { 
  parentClass?: string;
...
export default function bedRoomSet({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: bedRoomSetMain }); 
  }, [ 
    price,
    availability,
    color,
