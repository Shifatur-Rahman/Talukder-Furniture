...
import { salineStandMain } from "@/data/SalineStand"; 
 
// Filter state type (update this to match your reducer state exactly) 
 
// Props for Products1
interface SalineStandProps {
  parentClass?: string;
...
export default function SalineStand({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: salineStandMain }); 
  }, [ 
    price,
    availability,
    color,
