...
import { deliveryBedMain } from "@/data/DeliveryBed"; 
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1 
interface DeliveryBedProps {
  parentClass?: string;
...
export default function deliveryBed({ 
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: deliveryBedMain });
  }, [ 
    price,
    availability,
    color,
