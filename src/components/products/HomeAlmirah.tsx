...
import { homeAlmirahMain } from "@/data/HomeAlmirah"; 
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1 
interface HomeAlmirahProps {
  parentClass?: string;
...
export default function homeAlmirah({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: homeAlmirahMain });
  }, [ 
    price,
    availability,
    color,
