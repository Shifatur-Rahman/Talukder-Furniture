...
import { lowBackChairMain } from "@/data/LowBackChair"; 
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1
interface LowBackChairProps {
  parentClass?: string;
...
export default function lowBackChair({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: lowBackChairMain });
  }, [ 
    price,
    availability,
    color,
