...
import { teaTrolleyMain } from "@/data/teaTrolley";
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1
interface teaTrolleyProps {
  parentClass?: string;
...
export default function teaTrolley({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: teaTrolleyMain });
  }, [ 
    price,
    availability,
    color,
