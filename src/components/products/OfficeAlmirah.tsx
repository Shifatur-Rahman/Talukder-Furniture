...
import { officeAlmirahMain } from "@/data/OfficeAlmirah"; 
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1 
interface OfficeAlmirahProps {
  parentClass?: string;
...
export default function OfficeAlmirah({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: officeAlmirahMain }); 
  }, [ 
    price,
    availability,
    color,
