...
import { sofaCumBedMain } from "@/data/sofaCumBed"; 
 
// Filter state type (update this to match your reducer state exactly) 
 
// Props for Products1
interface SofaCumBedProps {
  parentClass?: string;
...
export default function SofaCumBed({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: sofaCumBedMain });
  }, [ 
    price,
    availability,
    color,
