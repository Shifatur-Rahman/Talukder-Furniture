...
import { highBackChairMain } from "@/data/HighBackChair"; 
 
// Filter state type (update this to match your reducer state exactly)   
 
// Props for Products1
interface HighBackChairProps {
  parentClass?: string;
...
export default function highBackChair({
  ...
  useEffect(() => {
     dispatch({ type: "FILTER_PRODUCTS", payload: highBackChairMain });
  }, [ 
    price,
    availability,
    color,
