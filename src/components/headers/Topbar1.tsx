        ...
        <div className="row">
              ...
              >
                <SwiperSlide className="swiper-slide">
                  <p className="text-caption-1 text_white">
                    ...
                    <span className="text_primary">50,000.00 BDT</span>
                  </p>
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <p className="text-caption-1 text_white">
          ...
          <div className="col-xl-4">
            <div className="topbar-right justify-content-end d-none d-xl-flex">
              <Link to={`/about`} className="text_white text-caption-1 link">
                About
              </Link>
              <Link to={`/contact`} className="text_white text-caption-1 link">
                Contact
              </Link>
              <Link
                to={`/store-list`}
